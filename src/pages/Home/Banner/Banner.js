        ...
        <div className='container my-5'>
            <div className='row'>
                ...
                <div className='col-lg-7 col-sm-12'>
                    ...
                    <a target='_blank' href='https://drive.google.com/file/d/1iymwjSkaPIWZ8yKAQQSuNO6YNrV8sB8m/view?usp=sharing'download rel="noreferrer" className='resume text-decoration-none text-white p-2 my-1 rounded-2'>Download My Resume</a>
                    </div>
